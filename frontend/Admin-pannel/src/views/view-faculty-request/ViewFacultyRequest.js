...
const ViewFacultyRequest = () => {
  ...
  const tableExample = [
    ...
    },
    {
      ...
      user: { name: 'Amit Mankodi', new: true, registered: 'Jan 1, 2021' },
      country: { name: 'India', flag: cifIn },
      usage: {
        value: 74,
        period: 'Jun 11, 2021 - Jul 10, 2021',
      ...
      payment: { name: 'Saurabh Tiwari', icon: cibCcStripe },
      activity: '1 hour ago',
    },
    {
      avatar: { src: avatar4, status: 'secondary' },
      user: { name: 'Shilpa Roy', new: true, registered: 'Jan 1, 2021' },
                ...
                <CTableBody>
                  {tableExample.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell className="text-center">
                        <CButton onClick={confirmSubmit} href="#/view-faculty-request">
                          Confirm
                        </CButton>
                      </CTableDataCell>
                      <CTableDataCell>
